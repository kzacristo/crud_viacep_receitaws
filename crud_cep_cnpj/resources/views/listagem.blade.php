...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{route('buscar')}}" class="nav-link">Fornecedor</a>
        </li>
    </ul>
    <!-- Right navbar links -->
        ...
        <div class="content-wrapper" style="min-height: 561px;">
            <section class="content-header" style="margin-bottom: 10px;">
                ...
                <div class="breadcrumb col-md-2">
                    <div class="row">
                        <div class="col-xs-6 ">
                            <a href="{{route('buscar')}}" class="btn btn-block btn-outline-success btn-lg"> <i class="fa fa-plus fa-fw">Cadastrar</i>
                            </a>
                        </div>
                    </div>
                </div>
